 ...
 */
public class JBoardingDayChooser extends JPanel implements ActionListener, KeyListener,
		FocusListener {
		...
		for (int y = 0; y < 7; y++) {
			for (int x = 0; x < 7; x++) {
				...
				if (y == 0) {
					...
					days[index].setVerticalAlignment(SwingConstants.TOP);
				}
