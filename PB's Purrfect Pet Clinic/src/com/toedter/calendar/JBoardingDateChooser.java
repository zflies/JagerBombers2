 ...
 */
public class JBoardingDateChooser extends JPanel implements ActionListener,
	...
	protected JBoardingCalendar jcalendar;
	 ...
	 */
	public JBoardingDateChooser(IDateEditor dateEditor) {
	 ...
	 *            the date or null
	 */
	public JBoardingDateChooser(Date date) {
		this(date, null);
	}
	 ...
	 *            format is used)
	 */
	public JBoardingDateChooser(Date date, String dateFormatString) {
	 ...
	 */
	public JBoardingDateChooser(String datePattern, String maskPattern, char placeholder) {
	 ...
	 *            JTextFieldDateEditor is used.
	 */
	public JBoardingDateChooser(JBoardingCalendar jcal, Date date, String dateFormatString,
			IDateEditor dateEditor) {
		...
		if (jcal == null) {
			jcalendar = new JBoardingCalendar(date);
		} else {
			jcalendar = jcal;
			if (date != null) {
		...
		changeListener = new ChangeListener() {
			...
			public void stateChanged(ChangeEvent e) {
				...
				if (popup.isVisible()
						&& JBoardingDateChooser.this.jcalendar.monthChooser
	 ...
	 */
	public JBoardingCalendar getJCalendar() {
		return jcalendar;
	}
