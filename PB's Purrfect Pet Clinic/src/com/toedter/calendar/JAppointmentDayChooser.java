 ...
 */
public class JAppointmentDayChooser extends JPanel implements ActionListener, KeyListener,
		FocusListener {
	 ...
	 */
	public JAppointmentDayChooser(boolean weekOfYearVisible) {
		setName("JDayChooser");
