 ...
 */
public class JAppointmentCalendar extends JPanel implements PropertyChangeListener {
	...
	/** the day chooser */
	protected JAppointmentDayChooser dayChooser;
	...
	/** the month chooser */
	protected JAppointmentMonthChooser monthChooser;

	/** the year chooser */
	protected JAppointmentYearChooser yearChooser;
	...
	public JAppointmentCalendar(Date date, Locale locale, boolean monthSpinner,
		...
		monthChooser = new JAppointmentMonthChooser(monthSpinner);
		yearChooser = new JAppointmentYearChooser();
		...
		dayChooser = new JAppointmentDayChooser(weekOfYearVisible);
	...
	public static void main(String[] s) {
		...
		JAppointmentCalendar jcalendar = new JAppointmentCalendar();
	 ...
	 */
	public JAppointmentDayChooser getDayChooser() {
		return dayChooser;
	}
	 ...
	 */
	public JAppointmentMonthChooser getMonthChooser() {
		return monthChooser;
	}
	 ...
	 */
	public JAppointmentYearChooser getYearChooser() {
		return yearChooser;
	}
