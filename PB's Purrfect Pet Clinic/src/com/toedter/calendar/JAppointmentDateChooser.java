 ...
 */
public class JAppointmentDateChooser extends JPanel implements ActionListener,
	...
	protected JAppointmentCalendar jcalendar;
	 ...
	 * is empty.
	 */
	public JAppointmentDateChooser() {
	 ...
	 */
	public JAppointmentDateChooser(IDateEditor dateEditor) {
	 ...
	 *            the date or null
	 */
	public JAppointmentDateChooser(Date date) {
		this(date, null);
	}
	 ...
	 *            format is used)
	 */
	public JAppointmentDateChooser(Date date, String dateFormatString) {
	 ...
	 */
	public JAppointmentDateChooser(String datePattern, String maskPattern, char placeholder) {
	 ...
	 *            JTextFieldDateEditor is used.
	 */
	public JAppointmentDateChooser(JAppointmentCalendar jcal, Date date, String dateFormatString,
			IDateEditor dateEditor) {
		...
		if (jcal == null) {
			jcalendar = new JAppointmentCalendar(date);
		} else {
			jcalendar = jcal;
			if (date != null) {
		...
		changeListener = new ChangeListener() {
			...
			public void stateChanged(ChangeEvent e) {
				...
				if (popup.isVisible()
						&& JAppointmentDateChooser.this.jcalendar.monthChooser
	 ...
	 */
	public JAppointmentCalendar getJCalendar() {
		return jcalendar;
	}
	...
	public static void main(String[] s) {
		...
		JAppointmentDateChooser dateChooser = new JAppointmentDateChooser();
