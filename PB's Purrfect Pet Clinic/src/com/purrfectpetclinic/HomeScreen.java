		...
		gl_desktopPaneCreate_Boarding.setHorizontalGroup(
			gl_desktopPaneCreate_Boarding.createParallelGroup(Alignment.LEADING)
				.addGroup(gl_desktopPaneCreate_Boarding.createSequentialGroup()
					.addContainerGap()
					.addComponent(lblOwner_Boarding, GroupLayout.DEFAULT_SIZE, 294, Short.MAX_VALUE)
					.addContainerGap())
				.addGroup(gl_desktopPaneCreate_Boarding.createSequentialGroup()
					.addContainerGap()
					.addGroup(gl_desktopPaneCreate_Boarding.createParallelGroup(Alignment.LEADING)
						.addComponent(lblFirstName_Boarding, GroupLayout.DEFAULT_SIZE, 105, Short.MAX_VALUE)
						.addComponent(lblLastName_Boarding, GroupLayout.DEFAULT_SIZE, 105, Short.MAX_VALUE))
					.addPreferredGap(ComponentPlacement.RELATED)
					.addGroup(gl_desktopPaneCreate_Boarding.createParallelGroup(Alignment.LEADING)
						.addComponent(txtFirstName_Boarding, GroupLayout.DEFAULT_SIZE, 185, Short.MAX_VALUE)
						.addComponent(txtLastName_Boarding, GroupLayout.DEFAULT_SIZE, 185, Short.MAX_VALUE))
					.addContainerGap())
				.addGroup(gl_desktopPaneCreate_Boarding.createSequentialGroup()
					.addContainerGap()
					.addGroup(gl_desktopPaneCreate_Boarding.createParallelGroup(Alignment.LEADING)
						.addGroup(gl_desktopPaneCreate_Boarding.createSequentialGroup()
							.addComponent(lblPetName_Boarding, GroupLayout.DEFAULT_SIZE, 72, Short.MAX_VALUE)
							.addPreferredGap(ComponentPlacement.RELATED)
							.addComponent(txtPetName_Boarding, GroupLayout.DEFAULT_SIZE, 141, Short.MAX_VALUE)
							.addPreferredGap(ComponentPlacement.RELATED)
							.addComponent(btnPetSearch_Boarding, GroupLayout.PREFERRED_SIZE, 71, Short.MAX_VALUE))
						.addGroup(gl_desktopPaneCreate_Boarding.createSequentialGroup()
							.addComponent(txtPetType_Boarding, GroupLayout.DEFAULT_SIZE, 99, Short.MAX_VALUE)
							.addGap(95)
							.addComponent(txtPetSize_Boarding, GroupLayout.DEFAULT_SIZE, 100, Short.MAX_VALUE)))
					.addContainerGap())
				.addGroup(gl_desktopPaneCreate_Boarding.createSequentialGroup()
					.addComponent(separator, GroupLayout.DEFAULT_SIZE, 304, Short.MAX_VALUE)
					.addContainerGap())
				.addGroup(gl_desktopPaneCreate_Boarding.createSequentialGroup()
					.addContainerGap()
					.addComponent(lblPet_Boarding, GroupLayout.DEFAULT_SIZE, 294, Short.MAX_VALUE)
					.addContainerGap())
				.addGroup(gl_desktopPaneCreate_Boarding.createSequentialGroup()
					.addComponent(separator_1, GroupLayout.DEFAULT_SIZE, 304, Short.MAX_VALUE)
					.addContainerGap())
				.addGroup(gl_desktopPaneCreate_Boarding.createSequentialGroup()
					.addContainerGap()
					.addComponent(lblScheduling_Boarding, GroupLayout.DEFAULT_SIZE, 294, Short.MAX_VALUE)
					.addContainerGap())
				.addGroup(gl_desktopPaneCreate_Boarding.createSequentialGroup()
					.addContainerGap()
					.addComponent(lblFrom_Boarding, GroupLayout.DEFAULT_SIZE, 71, Short.MAX_VALUE)
					.addGap(233))
				.addGroup(gl_desktopPaneCreate_Boarding.createSequentialGroup()
					.addContainerGap()
				...
				.addGroup(gl_desktopPaneCreate_Boarding.createSequentialGroup()
					.addContainerGap()
					.addComponent(lblTo_Boarding, GroupLayout.DEFAULT_SIZE, 71, Short.MAX_VALUE)
					.addGap(233))
				.addGroup(gl_desktopPaneCreate_Boarding.createSequentialGroup()
					.addContainerGap()
				...
				.addGroup(gl_desktopPaneCreate_Boarding.createSequentialGroup()
					.addContainerGap()
					.addComponent(lblKenel_Boarding, GroupLayout.DEFAULT_SIZE, 294, Short.MAX_VALUE)
					.addContainerGap())
				.addGroup(gl_desktopPaneCreate_Boarding.createSequentialGroup()
					.addContainerGap()
					.addComponent(chckbxBathinggrooming_Boarding, GroupLayout.DEFAULT_SIZE, 160, Short.MAX_VALUE)
					.addGap(148))
				.addGroup(gl_desktopPaneCreate_Boarding.createSequentialGroup()
					.addContainerGap()
					.addComponent(chckbxAdditionalPlayTime_Boarding, GroupLayout.DEFAULT_SIZE, 172, Short.MAX_VALUE)
					.addGap(136))
				.addGroup(gl_desktopPaneCreate_Boarding.createSequentialGroup()
					.addContainerGap()
				...
				.addGroup(gl_desktopPaneCreate_Boarding.createSequentialGroup()
					.addGap(213)
					.addComponent(btnCreate_Boarding, GroupLayout.DEFAULT_SIZE, 91, Short.MAX_VALUE)
					.addContainerGap())
		);
		gl_desktopPaneCreate_Boarding.setVerticalGroup(
			gl_desktopPaneCreate_Boarding.createParallelGroup(Alignment.LEADING)
				.addGroup(gl_desktopPaneCreate_Boarding.createSequentialGroup()
					...
					.addPreferredGap(ComponentPlacement.RELATED)
					.addComponent(editorPaneNotes_Boarding, GroupLayout.PREFERRED_SIZE, 62, Short.MAX_VALUE)
					.addPreferredGap(ComponentPlacement.RELATED)
