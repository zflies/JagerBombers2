 ...
 */
public class JAppointmentYearChooser extends JSpinField {
     ...
     */
    public JAppointmentYearChooser() {
        setName("JAppointmentYearChooser");
     ...
     */
    public void setDayChooser(JAppointmentDayChooser dayChooser) {
    ...
    static public void main(String[] s) {
        JFrame frame = new JFrame("JAppointmentYearChooser");
        frame.getContentPane().add(new JAppointmentYearChooser());
        frame.pack();
