/*
 *  JBoardingCalendar.java  - A bean for choosing a date
...
/**
 * JBoardingCalendar is a bean for entering a date by choosing the year, month and day.
 * 
 * @author Kai Toedter
 * @version $LastChangedRevision: 159 $
 * @version $LastChangedDate: 2011-06-22 21:07:24 +0200 (Mi, 22 Jun 2011) $
 */
public class JBoardingCalendar extends JPanel implements PropertyChangeListener {
	...
	/** the day chooser */
	protected JBoardingDayChooser dayChooser;
	...
	/** the month chooser */
	protected JBoardingMonthChooser monthChooser;

	/** the year chooser */
	protected JBoardingYearChooser yearChooser;
	...
	/**
	 * Default JBoardingCalendar constructor.
	 */
	public JBoardingCalendar() {
		this(null, null, true, true);
	}

	/**
	 * JBoardingCalendar constructor which allows the initial date to be set.
	 * 
	 * @param date
	 *            the date
	 */
	public JBoardingCalendar(Date date) {
		this(date, null, true, true);
	}

	/**
	 * JBoardingCalendar constructor which allows the initial calendar to be set.
	 * 
	 * @param calendar
	 *            the calendar
	 */
	public JBoardingCalendar(Calendar calendar) {
		this(null, null, true, true);
		setCalendar(calendar);
	}

	/**
	 * JBoardingCalendar constructor allowing the initial locale to be set.
	 * 
	 * @param locale
	 *            the new locale
	 */
	public JBoardingCalendar(Locale locale) {
		this(null, locale, true, true);
	}

	/**
	 * JBoardingCalendar constructor specifying both the initial date and locale.
	 * 
	 * @param date
	 *            the date
	 * @param locale
	 *            the new locale
	 */
	public JBoardingCalendar(Date date, Locale locale) {
		this(date, locale, true, true);
	}

	/**
	 * JBoardingCalendar constructor specifying both the initial date and the month
	 * spinner type.
	 * 
	 * @param date
	 *            the date
	 ...
	 */
	public JBoardingCalendar(Date date, boolean monthSpinner) {
		this(date, null, monthSpinner, true);
	}

	/**
	 * JBoardingCalendar constructor specifying both the locale and the month spinner.
	 * 
	 * @param locale
	 *            the locale
	 * @param monthSpinner
	 *            false, if no month spinner should be used
	 */
	public JBoardingCalendar(Locale locale, boolean monthSpinner) {
		this(null, locale, monthSpinner, true);
	}

	/**
	 * JBoardingCalendar constructor specifying the month spinner type.
	 * 
	 * @param monthSpinner
	 *            false, if no month spinner should be used
	 */
	public JBoardingCalendar(boolean monthSpinner) {
		this(null, null, monthSpinner, true);
	}

	/**
	 * JBoardingCalendar constructor with month spinner parameter.
	 * 
	 * @param date
	 *            the date
	 * @param locale
	 ...
	 */
	public JBoardingCalendar(Date date, Locale locale, boolean monthSpinner,
			boolean weekOfYearVisible) {

		setName("JBoardingCalendar");
		...
		monthChooser = new JBoardingMonthChooser(monthSpinner);
		yearChooser = new JBoardingYearChooser();
		...
		dayChooser = new JBoardingDayChooser(weekOfYearVisible);
	...
	/**
	 * Creates a JFrame with a JBoardingCalendar inside and can be used for testing.
	 * 
	 * @param s
	 *            The command line arguments
	 */
	public static void main(String[] s) {
		JFrame frame = new JFrame("JBoardingCalendar");

		JBoardingCalendar jboardingcalendar = new JBoardingCalendar();
		frame.getContentPane().add(jboardingcalendar);
		frame.pack();
	...
	/**
	 * Gets the dayChooser attribute of the JBoardingCalendar object
	 * 
	 * @return the dayChooser value
	 */
	public JBoardingDayChooser getDayChooser() {
		return dayChooser;
	}
	...
	/**
	 * Gets the monthChooser attribute of the JBoardingCalendar object
	 * 
	 * @return the monthChooser value
	 */
	public JBoardingMonthChooser getMonthChooser() {
		return monthChooser;
	}

	/**
	 * Gets the yearChooser attribute of the JBoardingCalendar object
	 * 
	 * @return the yearChooser value
	 */
	public JBoardingYearChooser getYearChooser() {
		return yearChooser;
	}
	...
	/**
	 * JBoardingCalendar is a PropertyChangeListener, for its day, month and year
	 * chooser.
	 * 
	 * @param evt
	...
	/**
	 * Sets the calendar attribute of the JBoardingCalendar object
	 * 
	 * @param c
	...
	/**
	 * Enable or disable the JBoardingCalendar.
	 * 
	 * @param enabled
	...
	private void relayoutSpecialButtonPanel() {
		...
		try {
			resourceBundle = UTF8ResourceBundle.getBundle(
					"com.toedter.calendar.jboardingcalendar", locale);
		} catch (Exception e) {
