 ...
 */
public class JAppointmentMonthChooser extends JPanel implements ItemListener,
		ChangeListener {
	...
	private JAppointmentDayChooser dayChooser;

	private JAppointmentYearChooser yearChooser;
	 ...
	 */
	public JAppointmentMonthChooser() {
		this(true);
	}
	 ...
	 */
	public JAppointmentMonthChooser(boolean hasSpinner) {
		super();
	 ...
	 *            the day chooser
	 */
	public void setDayChooser(JAppointmentDayChooser dayChooser2) {
	 ...
	 */
	public void setYearChooser(JAppointmentYearChooser yearChooser) {
